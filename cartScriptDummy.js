    ...
    products.forEach(product => {
        ...
        li.innerHTML = `
            <div class="h-24 w-24 flex-shrink-0 overflow-hidden rounded-md border border-gray-200">
                <img alt="${product.imageAlt}" src="${product.thumbnail}" class="h-full w-full object-cover object-center" />
            </div>
...
function undoDelete() {
    if (deletedProduct.id) { // Check if there is a deleted product to restore
